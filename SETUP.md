...
- Click the **Tools** ![Tools](https://github.com/Sigourn/nerevarrising/tree/master/MO2/MO_ini.png) button, and click **INI Editor**. Select the **the falloutcustom.ini** tab.
...
- Click the **Configure profiles** ![Profiles](https://github.com/Sigourn/nerevarrising/tree/master/MO2/MO_Profiles.png) button.
...
- Click the **Modify Executables** ![Executables](https://github.com/Sigourn/nerevarrising/tree/master/MO2/MO_Executables.png) button.
...
- Click the **Modify Executables** ![Executables](https://github.com/Sigourn/nerevarrising/tree/master/MO2/MO_Executables.png) button.
- Click the **Add an executable** ![AddExe](https://github.com/Sigourn/nerevarrising/tree/master/MO2/MO2_Add_File.png) button and choose **Add from file...**.
...
![ModExists](https://github.com/Sigourn/nerevarrising/tree/master/MO2/MO2_ModExists.png)
...
- In MO2, click the **Install a new mod from archive** ![Archive](https://github.com/Sigourn/nerevarrising/tree/master/MO2/MO_Archive.png) button.
